...
export default function SelectedData() {
  ...
  const handleDelete = () => {
    Object.entries(selectedGroupItems).forEach(([, selectedIds]) => {
  ...
  const hasSelectedItems = Object.values(selectedGroupItems).some(
    (set) => set.size > 0
  );
            ...
            <div className="flex justify-between items-center mb-2">
              ...
              <div className="flex items-center">
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleGroupSelection(groupId, e.target.checked)
                  }
                  className="mr-2"
                />
              </div>
                ...
                >
                  <div className="flex items-center">
                    <input
                      type="checkbox"
                      checked={
                        selectedGroupItems[groupId]?.has(item.uniqueId) || false
                      }
                      onChange={() =>
                        handleItemSelection(groupId, item.uniqueId)
                      }
                      className="mr-2"
                    />
                    <span>
